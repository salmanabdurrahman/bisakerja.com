...
Berdasarkan struktur repository saat ini, project masih dominan dokumentasi (`docs/`) dan belum ditemukan source frontend (`apps/web`).

- Implementasi kode frontend: **⬜ Not Implemented**
- Kesiapan roadmap/checklist frontend: **📝 Documented**
...
| bootstrap `apps/web` (Next.js App Router) | ⬜ | - | - | - | - |
| struktur domain (`features/`, `components/`, `services/`, `lib/`) | ⬜ | - | - | - | - |
| baseline env config frontend | ⬜ | - | - | - | - |
| lint frontend (`eslint`) | ⬜ | - | - | - | - |
| type-check frontend (`tsc --noEmit`) | ⬜ | - | - | - | - |
| unit/component test baseline | ⬜ | - | - | - | - |
| build gate frontend (`next build`) | ⬜ | - | - | - | - |
