...
Seluruh dokumentasi Bisakerja (backend dan frontend) ada di folder `docs/` dan dibagi modular:

## 1) PRD (Entry Point)

- [`prd/bisakerja-api-prd.md`](./prd/bisakerja-api-prd.md)
- [`prd/bisakerja-frontend-prd.md`](./prd/bisakerja-frontend-prd.md)
...
- [`frontend/traceability/frontend-backend-traceability.md`](./frontend/traceability/frontend-backend-traceability.md)

## 6) System Flows

- [`flows/README.md`](./flows/README.md)
- [`flows/auth-subscription-flow.md`](./flows/auth-subscription-flow.md)
- [`flows/scraping-matching-flow.md`](./flows/scraping-matching-flow.md)
- [`flows/search-serving-flow.md`](./flows/search-serving-flow.md)
- [`flows/admin-ops-flow.md`](./flows/admin-ops-flow.md)

## 7) Implementation Phases

- [`phases/README.md`](./phases/README.md)
- [`phases/implementation-roadmap.md`](./phases/implementation-roadmap.md)
- [`phases/implementation-checklist.md`](./phases/implementation-checklist.md)

## 8) Engineering Standards

- [`standards/README.md`](./standards/README.md)
- [`standards/go-coding-standards.md`](./standards/go-coding-standards.md)
- [`standards/nextjs-coding-standards.md`](./standards/nextjs-coding-standards.md)
- [`standards/comments-and-docstrings.md`](./standards/comments-and-docstrings.md)
- [`standards/testing-strategy.md`](./standards/testing-strategy.md)
...
- [`standards/code-review-checklist.md`](./standards/code-review-checklist.md)
- [`standards/adr-guidelines.md`](./standards/adr-guidelines.md)

## 9) Implementation Kickoff (Wajib Sebelum Coding)

- [`phases/implementation-kickoff.md`](./phases/implementation-kickoff.md)
- [`phases/implementation-roadmap.md`](./phases/implementation-roadmap.md)
- [`phases/implementation-checklist.md`](./phases/implementation-checklist.md)
- [`frontend/phases/implementation-roadmap.md`](./frontend/phases/implementation-roadmap.md)
- [`frontend/phases/implementation-checklist.md`](./frontend/phases/implementation-checklist.md)
- [`frontend/traceability/frontend-backend-traceability.md`](./frontend/traceability/frontend-backend-traceability.md)
- [`../AGENTS.md`](../AGENTS.md)
